...
class AvvoApi::HeadshotTest < Test::Unit::TestCase
  ...
  context "AvvoApi::Headshot" do
    ...
    should "get the correct url" do
      stub_request(:get, "https://www.avvo.com/api/1/lawyers/1/headshot.json").to_return(:body => {:headshot_url => "blah"}.to_json)
      AvvoApi::Headshot.find(:one, :params => {:lawyer_id => 1})
      assert_requested(:get, "https://www.avvo.com/api/1/lawyers/1/headshot.json")
    end

    should "be able to create a new headshot" do
      @headshot = AvvoApi::Headshot.new(:lawyer_id => 1)
      stub_request(:post, "https://www.avvo.com/api/1/lawyers/1/headshot.json")
      @headshot.save
      assert_requested(:post, "https://www.avvo.com/api/1/lawyers/1/headshot.json")
    end
    ...
    should "be able to destroy a headshot" do
      stub_request(:get, "https://www.avvo.com/api/1/lawyers/1/headshot.json").to_return(:body => {:headshot_url => "blah"}.to_json)
      @headshot = AvvoApi::Headshot.find(:one, :params => {:lawyer_id => 1})
      stub_request(:delete, "https://www.avvo.com/api/1/lawyers/1/headshot.json")
      @headshot.destroy
      assert_requested(:delete, "https://www.avvo.com/api/1/lawyers/1/headshot.json")      
    end
